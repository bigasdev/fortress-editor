...
SRC_DIRS := src/imgui src/core src/entity/tabs src/entity src/entity/data src/entity/actions src/entity/editors src/entity/visualizers src/renderer src/res src/game src/tools
